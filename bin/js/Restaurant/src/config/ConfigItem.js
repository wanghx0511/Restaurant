...
var ConfigItem = (function () {
    function ConfigItem() {
        this.confJson = eval(Loader.getRes("res/json/ConfItem.json"));
    }
    ConfigItem.prototype.get = function (sn) {
    ...
    ConfigItem.prototype.getBy = function () {
        var args = [];
    ...
    ConfigItem.prototype.findBy = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ConfigItem.prototype.findAll = function () {
