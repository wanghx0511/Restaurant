var ConfigItemMerge = (function () {
    function ConfigItemMerge() {
        this.confJson = eval(Loader.getRes("res/json/ConfItemMerge.json"));
    }
    ConfigItemMerge.prototype.get = function (sn) {
    ...
    ConfigItemMerge.prototype.getBy = function () {
        var args = [];
    ...
    ConfigItemMerge.prototype.findBy = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ConfigItemMerge.prototype.findAll = function () {
        return this.confJson;
    };
    return ConfigItemMerge;
}());
//# sourceMappingURL=ConfigItemMerge.js.map