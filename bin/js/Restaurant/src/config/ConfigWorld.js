var ConfigWorld = (function () {
    function ConfigWorld() {
        this.confJson = eval(Loader.getRes("res/json/ConfWorld.json"));
    }
    ConfigWorld.prototype.get = function (sn) {
    ...
    ConfigWorld.prototype.getBy = function () {
        var args = [];
    ...
    ConfigWorld.prototype.findBy = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ConfigWorld.prototype.findAll = function () {
        return this.confJson;
    };
    return ConfigWorld;
}());
//# sourceMappingURL=ConfigWorld.js.map