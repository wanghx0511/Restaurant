var ConfigPos = (function () {
    function ConfigPos() {
        this.confJson = eval(Loader.getRes("res/json/ConfPos.json"));
    }
    ConfigPos.prototype.get = function (sn) {
    ...
    ConfigPos.prototype.getBy = function () {
        var args = [];
    ...
    ConfigPos.prototype.findBy = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ConfigPos.prototype.findAll = function () {
        return this.confJson;
    };
    return ConfigPos;
}());
//# sourceMappingURL=ConfigPos.js.map