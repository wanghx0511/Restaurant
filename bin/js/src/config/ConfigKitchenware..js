var ConfigKitchenware = (function () {
    function ConfigKitchenware() {
        this.confJson = eval(Loader.getRes("res/json/Confkitchenware.json"));
    }
    ConfigKitchenware.prototype.get = function (sn) {
    ...
    ConfigKitchenware.prototype.getBy = function () {
        var args = [];
    ...
    ConfigKitchenware.prototype.findBy = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    ConfigKitchenware.prototype.findAll = function () {
